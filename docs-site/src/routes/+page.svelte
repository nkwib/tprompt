...
<section class="hero">
  <div class="hero-grid">
    <div class="hero-copy">
      ...
      <pre class="install"><span class="prompt">$</span> pnpm add tprompt</pre>
    </div>
    ...
    <aside class="demo">
      ...
      <pre class="demo-code"><code><span class="kw">import</span> &lbrace; prompt &rbrace; <span class="kw">from</span> <span class="str">'tprompt'</span>;
...
<span class="kw">import</span> &lbrace; prompt &rbrace; <span class="kw">from</span> <span class="str">'tprompt'</span>;
<span class="fn">prompt</span>(<span class="str">'Hi &lbrace;&lbrace;name&rbrace;&rbrace;'</span>);

<span class="cmt">// Single-brace: {'{var}'}</span>
<span class="kw">import</span> &lbrace; prompt &rbrace; <span class="kw">from</span> <span class="str">'tprompt/single-brace'</span>;
<span class="fn">prompt</span>(<span class="str">'Hi &lbrace;name&rbrace;'</span>);

<span class="cmt">// Bring your own:</span>
<span class="kw">import</span> &lbrace; makePromptTag &rbrace; <span class="kw">from</span> <span class="str">'tprompt'</span>;
